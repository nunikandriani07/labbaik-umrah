        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            <button
              ...
              className="px-4 py-2 rounded-xl text-[#0D4A28] font-semibold hover:bg-[#C9A84C]/10 transition"
            >
              Masuk
            </button>
            <button
              onClick={() => onNavigate('dashboard')}
              className="px-5 py-2.5 rounded-xl bg-[#1B6B3A] hover:bg-[#0D4A28] text-white font-semibold shadow-md border border-[#C9A84C]/30 flex items-center gap-2 hover:scale-[1.02] transition"
            >
          ...
          <div className="flex flex-col gap-4 font-medium text-slate-700">
            ...
            <div className="flex flex-col gap-2 pt-2">
              <button
                ...
                className="w-full py-2.5 rounded-xl border border-[#1B6B3A] text-[#1B6B3A] font-semibold"
              >
                Masuk
              </button>
              <button
                onClick={() => { setMobileMenuOpen(false); onNavigate('dashboard'); }}
                className="w-full py-2.5 rounded-xl bg-[#1B6B3A] text-white font-semibold shadow-md"
              >
